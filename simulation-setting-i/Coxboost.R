...
run_Coxboost = function(data, n, p, s){
  ...
  # perform CoxBoost and extract parameter estimates
  beta_hat = coef(CoxBoost(y[,1], y[,2], x))
...
CB = function(data, n, p, s){
  run_Coxboost(data, n, p, s)
}
