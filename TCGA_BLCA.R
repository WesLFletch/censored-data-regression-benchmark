...
# QUICK START GUIDE:
# Run this file top to bottom. Once done, the additional files `blca_XXXX.txt` can be
# safely removed. A timestamped version of `BLCA.RDS` is also available in the repository.
